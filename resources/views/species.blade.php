        ...
        response.data.forEach(pet => {
            ...
            <div class="col-lg-3 col-md-3 col-sm-12">
                <div class="card card-hoverable h-100" style="${isFirstTime ? 'display: none;' : ''}; position: relative;">
                    <div class="card-background" style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; background-image: url('${image}'); background-size: cover; background-position: center; filter: blur(8px); z-index: -1;"></div>
