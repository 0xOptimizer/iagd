<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvas-input-sire">
    ...
    <div class="offcanvas-body">
        ...
        <div class="has-sire card card-interactable" style="display: none;">
            <div class="select-gender-option card-body d-flex align-items-center" data-option="Male">
                <img class="pet-sire-preview-image me-4" src="{{ asset('images/freepik_male.png') }}" width="48" height="48">
                <div>
        ...
        <hr class="has-sire my-5" style="display: none;">
