    ...
    <div class="offcanvas-body">
        <div class="row">
            <div class="submit-please_wait-text col-12 text-center">
                <span class="text-gradient-primary" style="font-size: 24px;">Please wait</span>
            </div>
            <div class="col-12 text-center my-5">
                <div class="submit-nucleus-text DNA_cont" style="width: 100%;">
                ...
                <div class="card" style="height: 150px;">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <br>
                            <span style="opacity: 0.16;">Please hang on while we process your data...</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12 submit-uploading-after-loading-group" style="display: none;">
                <div class="card" style="height: 150px;">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            <span class="text-gradient-primary" style="font-size: 24px;">Uploading Details</span>
                            <br>
            ...
            <div class="col-sm-12 submit-assigning-inactive-loading-group" style="display: none;">
                <div class="card" style="height: 150px;">
                    <div class="card-body d-flex align-items-center">
                        <div class="text-center me-4" role="status" style="width: 100px; color: rgb(231, 231, 231); opacity: 0.16;">
                            <i class="bi bi-dash-circle" style="font-size: 64px;"></i>
            ...
            <div class="col-sm-12 submit-assigning-before-loading-group" style="display: none;">
                <div class="card" style="height: 150px;">
                    <div class="card-body d-flex align-items-center">
                        <div class=" factory-loader me-4" role="status">
                            <span class="visually-hidden">Loading...</span>
            ...
            <div class="col-sm-12 submit-assigning-after-loading-group" style="display: none;">
                <div class="card" style="height: 150px;">
                    <div class="card-body d-flex align-items-center">
                        <div class="text-center me-4" role="status" style="width: 100px; color: #c294ff;">
                            <i class="bi bi-check2-circle" style="font-size: 64px;"></i>
